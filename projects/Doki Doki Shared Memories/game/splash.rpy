...
init python:
    ...
    splash_message_default = "You're mad thinking you could ever save me..."
    ...
    ## Example: recolorize("gui/menu_bg.png", "#f6f6f6", "#e6ffff", 1.25)

    def recolorize(path, blackCol="#000000", whiteCol="#000000", contr=1.29):
        return im.MatrixColor(im.MatrixColor(im.MatrixColor(path, im.matrix.desaturate() * im.matrix.contrast(contr)), im.matrix.colorize("#00f", "#2e7fab")
...
image menu_bg:
    topleft
    "gui/menu_bg.png"
    # recolorize("gui/menu_bg.png", "#30b0d7", "#080808", 1)
    menu_bg_move
...
image game_menu_bg:
    topleft
    "gui/menu_bg.png"
    # recolorize("gui/menu_bg.png", "#30a5c9", "#080808", 1)
    menu_bg_loop
