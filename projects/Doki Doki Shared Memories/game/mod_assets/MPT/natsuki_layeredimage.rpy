...
layeredimage natsuki turned:
    ...
    group left: #Left arm.
        ...
        attribute ldown if_any(["dress"]):
            "mod_assets/natsuki sprites/1l.png"
        attribute lhip if_any(["dress"]):
            "mod_assets/natsuki sprites/2l.png"
    ...
    group right: #right half of her body.
        ...
        attribute rdown if_any(["dress"]):
            "mod_assets/natsuki sprites/1r.png"
        attribute rhip if_any(["dress"]):
            "mod_assets/natsuki sprites/2r.png"
    ...
    group head: #This needs to render above her body for her "turned" pose.
        ...
        attribute ftaeye:
            "mod_assets/MPT/natsuki/natsuki_face_turnedaway_open.png"
...
layeredimage natsuki cross:
    ...
    always:
        "mod_assets/MPT/natsuki/natsuki_crossed(fs)_uniform.png" if_all(["uniform"]) if_any(["fs","fta", "ftao"])
    always:
        "mod_assets/natsuki sprites/natsuki_crossedft_uniform.png" if_all(["uniform2"]) if_any(["fs","fta", "ftao"])
    always:
        "mod_assets/MPT/natsuki/natsuki_crossed(ff)_casual.png" if_all(["casual","ff"])
    always:
        "mod_assets/MPT/natsuki/natsuki_crossed(fs)_casual.png" if_all(["casual"]) if_any(["fs","fta", "ftao"])
    always:
        "mod_assets/natsuki sprites/3.png" if_all(["dress","ff"])
    always:
        "mod_assets/natsuki sprites/3.png" if_all(["dress"]) if_any(["fs"])
    always:
        "mod_assets/natsuki sprites/4.png" if_all(["dress"]) if_any(["fta", "ftao"])
